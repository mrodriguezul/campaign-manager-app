...
export class Init1789167764628 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "call_logs" ("call_logs_id" SERIAL NOT NULL, "notes" character varying(100) NOT NULL, "status" character varying(30) NOT NULL, "summary" character varying(180), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "lead_id" integer NOT NULL, "agent_id" integer NOT NULL, CONSTRAINT "PK_fb226b52b1b7f25b2a62ffb4a31" PRIMARY KEY ("call_logs_id"))`);
